...
const angles = [
  ...
  { deg: 45, rad: "π/4", sin: "√2/2", cos: "√2/2" }, { deg: 60, rad: "π/3", sin: "√3/2", cos: "1/2" },
  { deg: 90, rad: "π/2", sin: "1", cos: "0" }, { deg: 120, rad: "2π/3", sin: "√3/2", cos: "−1/2" },
  { deg: 135, rad: "3π/4", sin: "√2/2", cos: "−√2/2" }, { deg: 150, rad: "5π/6", sin: "1/2", cos: "−√3/2" },
...
<style scoped>
.unit-circle{margin:0 0 18px;padding:18px 22px;border:1px solid rgba(23,43,66,.13);border-radius: 8px;background:#ffffff}.unit-circle svg{display:block;width:100%;max-height:330px}.axis{stroke:#8c9895;stroke-width:1.5}.circle{fill:none;stroke:#172b42;stroke-width:2}.radius{stroke:#172b42;stroke-width:2.5}.cos-leg{stroke:#245fa8;stroke-width:5;stroke-linecap:round}.sin-leg{stroke:#a06444;stroke-width:5;stroke-linecap:round}.angle-arc{fill:none;stroke:#71807d;stroke-width:1.5}.active-point{fill:#172b42}.standard-point{fill:#245fa8}.angle-label{fill:#53625f;font:15px Georgia,serif;text-anchor:middle}.theta{fill:#53625f;font:italic 14px Georgia,serif}.legend-title{fill:#245fa8;font:500 9px var(--font-mono);letter-spacing:.12em}.ordered-pair{fill:#172b42;font:italic 22px Georgia,serif}.value{font:18px Georgia,serif}.cos-value{fill:#245fa8}.sin-value{fill:#a06444}.focus,.guide{fill:#71807d;font:11px var(--font-mono)}.unit-circle figcaption{text-align:center;color:#596865;line-height:1.5}.unit-circle.compact{max-width:610px;margin:12px auto 0;padding:5px 12px}.unit-circle.compact svg{max-height:210px}.unit-circle.compact .legend-title{font-size:10px}@media(max-width:650px){.unit-circle{padding:8px}.unit-circle svg{min-height:240px}.angle-label{font-size:12px}.legend{transform:translate(320px,83px)}}
</style>
